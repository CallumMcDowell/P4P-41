...
`timescale 1 ps / 1 ps
module qsys0_mm_interconnect_1 (
	...
	wire    [2:0] vexriscvavalon_0_instruction_bus_translator_avalon_universal_master_0_burstcount;    // VexRiscvAvalon_0_instruction_bus_translator:uav_burstcount -> VexRiscvAvalon_0_instruction_bus_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                                   // rsp_mux:src_valid -> VexRiscvAvalon_0_instruction_bus_agent:rp_valid
	wire  [101:0] rsp_mux_src_data;                                                                    // rsp_mux:src_data -> VexRiscvAvalon_0_instruction_bus_agent:rp_data
	wire          rsp_mux_src_ready;                                                                   // VexRiscvAvalon_0_instruction_bus_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                                 // rsp_mux:src_channel -> VexRiscvAvalon_0_instruction_bus_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                           // rsp_mux:src_startofpacket -> VexRiscvAvalon_0_instruction_bus_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                             // rsp_mux:src_endofpacket -> VexRiscvAvalon_0_instruction_bus_agent:rp_endofpacket
	...
	wire  [101:0] cmd_mux_src_data;                                                                    // cmd_mux:src_data -> onchip_memory2_0_s1_agent:cp_data
	wire          cmd_mux_src_ready;                                                                   // onchip_memory2_0_s1_agent:cp_ready -> cmd_mux:src_ready
	wire    [0:0] cmd_mux_src_channel;                                                                 // cmd_mux:src_channel -> onchip_memory2_0_s1_agent:cp_channel
	...
	wire          vexriscvavalon_0_instruction_bus_agent_cp_valid;                                     // VexRiscvAvalon_0_instruction_bus_agent:cp_valid -> router:sink_valid
	wire  [101:0] vexriscvavalon_0_instruction_bus_agent_cp_data;                                      // VexRiscvAvalon_0_instruction_bus_agent:cp_data -> router:sink_data
	wire          vexriscvavalon_0_instruction_bus_agent_cp_ready;                                     // router:sink_ready -> VexRiscvAvalon_0_instruction_bus_agent:cp_ready
	wire          vexriscvavalon_0_instruction_bus_agent_cp_startofpacket;                             // VexRiscvAvalon_0_instruction_bus_agent:cp_startofpacket -> router:sink_startofpacket
	wire          vexriscvavalon_0_instruction_bus_agent_cp_endofpacket;                               // VexRiscvAvalon_0_instruction_bus_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire  [101:0] onchip_memory2_0_s1_agent_rp_data;                                                   // onchip_memory2_0_s1_agent:rp_data -> router_001:sink_data
	...
	qsys0_mm_interconnect_1_router router (
	...
	qsys0_mm_interconnect_1_router_001 router_001 (
	...
	qsys0_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (pll_0_outclk0_clk),                                  //       clk.clk
		.reset              (VexRiscvAvalon_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys0_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (pll_0_outclk0_clk),                                  //       clk.clk
		.reset               (VexRiscvAvalon_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys0_mm_interconnect_1_cmd_demux rsp_demux (
		.clk                (pll_0_outclk0_clk),                                  //       clk.clk
		.reset              (VexRiscvAvalon_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys0_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (pll_0_outclk0_clk),                                  //       clk.clk
		.reset               (VexRiscvAvalon_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
