...
`timescale 1 ps / 1 ps
module qsys0_mm_interconnect_0 (
	...
	wire    [2:0] vexriscvavalon_0_data_bus_translator_avalon_universal_master_0_burstcount;    // VexRiscvAvalon_0_data_bus_translator:uav_burstcount -> VexRiscvAvalon_0_data_bus_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                            // rsp_mux:src_valid -> VexRiscvAvalon_0_data_bus_agent:rp_valid
	wire  [103:0] rsp_mux_src_data;                                                             // rsp_mux:src_data -> VexRiscvAvalon_0_data_bus_agent:rp_data
	wire          rsp_mux_src_ready;                                                            // VexRiscvAvalon_0_data_bus_agent:rp_ready -> rsp_mux:src_ready
	wire    [3:0] rsp_mux_src_channel;                                                          // rsp_mux:src_channel -> VexRiscvAvalon_0_data_bus_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                    // rsp_mux:src_startofpacket -> VexRiscvAvalon_0_data_bus_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                      // rsp_mux:src_endofpacket -> VexRiscvAvalon_0_data_bus_agent:rp_endofpacket
	...
	wire  [104:0] vexriscvavalon_0_irq_controller_agent_rf_source_data;                         // VexRiscvAvalon_0_irq_controller_agent:rf_source_data -> VexRiscvAvalon_0_irq_controller_agent_rsp_fifo:in_data
	...
	wire  [104:0] vexriscvavalon_0_irq_controller_agent_rsp_fifo_out_data;                      // VexRiscvAvalon_0_irq_controller_agent_rsp_fifo:out_data -> VexRiscvAvalon_0_irq_controller_agent:rf_sink_data
	...
	wire          cmd_mux_src_valid;                                                            // cmd_mux:src_valid -> VexRiscvAvalon_0_irq_controller_agent:cp_valid
	wire  [103:0] cmd_mux_src_data;                                                             // cmd_mux:src_data -> VexRiscvAvalon_0_irq_controller_agent:cp_data
	wire          cmd_mux_src_ready;                                                            // VexRiscvAvalon_0_irq_controller_agent:cp_ready -> cmd_mux:src_ready
	wire    [3:0] cmd_mux_src_channel;                                                          // cmd_mux:src_channel -> VexRiscvAvalon_0_irq_controller_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                                    // cmd_mux:src_startofpacket -> VexRiscvAvalon_0_irq_controller_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                                      // cmd_mux:src_endofpacket -> VexRiscvAvalon_0_irq_controller_agent:cp_endofpacket
	...
	wire  [103:0] cmd_mux_003_src_data;                                                         // cmd_mux_003:src_data -> onchip_memory2_0_s2_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                        // onchip_memory2_0_s2_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                                      // cmd_mux_003:src_channel -> onchip_memory2_0_s2_agent:cp_channel
	...
	wire  [103:0] vexriscvavalon_0_data_bus_agent_cp_data;                                      // VexRiscvAvalon_0_data_bus_agent:cp_data -> router:sink_data
	...
	wire          vexriscvavalon_0_irq_controller_agent_rp_valid;                               // VexRiscvAvalon_0_irq_controller_agent:rp_valid -> router_001:sink_valid
	wire  [103:0] vexriscvavalon_0_irq_controller_agent_rp_data;                                // VexRiscvAvalon_0_irq_controller_agent:rp_data -> router_001:sink_data
	wire          vexriscvavalon_0_irq_controller_agent_rp_ready;                               // router_001:sink_ready -> VexRiscvAvalon_0_irq_controller_agent:rp_ready
	wire          vexriscvavalon_0_irq_controller_agent_rp_startofpacket;                       // VexRiscvAvalon_0_irq_controller_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire          vexriscvavalon_0_irq_controller_agent_rp_endofpacket;                         // VexRiscvAvalon_0_irq_controller_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [103:0] pio_0_s1_agent_rp_data;                                                       // pio_0_s1_agent:rp_data -> router_002:sink_data
	...
	wire          vexriscvavalon_0_irq_controller_agent_rdata_fifo_src_valid;                   // VexRiscvAvalon_0_irq_controller_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] vexriscvavalon_0_irq_controller_agent_rdata_fifo_src_data;                    // VexRiscvAvalon_0_irq_controller_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          vexriscvavalon_0_irq_controller_agent_rdata_fifo_src_ready;                   // avalon_st_adapter:in_0_ready -> VexRiscvAvalon_0_irq_controller_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_out_0_valid;                                                // avalon_st_adapter:out_0_valid -> VexRiscvAvalon_0_irq_controller_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                                 // avalon_st_adapter:out_0_data -> VexRiscvAvalon_0_irq_controller_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                                // VexRiscvAvalon_0_irq_controller_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                                // avalon_st_adapter:out_0_error -> VexRiscvAvalon_0_irq_controller_agent:rdata_fifo_sink_error
	...
	qsys0_mm_interconnect_0_router router (
	...
	qsys0_mm_interconnect_0_router_001 router_001 (
	...
	qsys0_mm_interconnect_0_router_001 router_002 (
	...
	qsys0_mm_interconnect_0_router_001 router_003 (
	...
	qsys0_mm_interconnect_0_router_001 router_004 (
	...
	qsys0_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (pll_0_outclk0_clk),                                  //       clk.clk
		.reset              (VexRiscvAvalon_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys0_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (pll_0_outclk0_clk),                                  //       clk.clk
		.reset               (VexRiscvAvalon_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys0_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (pll_0_outclk0_clk),                                  //       clk.clk
		.reset               (VexRiscvAvalon_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys0_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (pll_0_outclk0_clk),                                  //       clk.clk
		.reset               (VexRiscvAvalon_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys0_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (pll_0_outclk0_clk),                                  //       clk.clk
		.reset               (VexRiscvAvalon_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys0_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (pll_0_outclk0_clk),                                  //       clk.clk
		.reset              (VexRiscvAvalon_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys0_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (pll_0_outclk0_clk),                                  //       clk.clk
		.reset              (VexRiscvAvalon_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys0_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (pll_0_outclk0_clk),                                  //       clk.clk
		.reset              (VexRiscvAvalon_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys0_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (pll_0_outclk0_clk),                                  //       clk.clk
		.reset              (VexRiscvAvalon_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys0_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (pll_0_outclk0_clk),                                  //       clk.clk
		.reset               (VexRiscvAvalon_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys0_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
